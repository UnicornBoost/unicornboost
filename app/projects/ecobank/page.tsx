...
function Ecobank() {
  return (
    <div className="mt-16 md:w-4/5 px-8 mx-auto">
      <h1 className="text-4xl font-medium text-center">Eco Bank</h1>
      <div className="bg-white text-black p-8 md:text-lg rounded-md my-8">
        <p>
      ...
      <div className="flex flex-wrap gap-8 my-16 md:flex-row flex-col">
