    ...
    <main className="mt-16 mx-auto md:w-1/2 px-8 md:px-0">
      ...
      <div className="grid md:grid-cols-2 gap-8 my-16">
        <a
          ...
          className="bg-white rounded-md p-4 space-y-4"
        >
          <div className="flex items-start">
            <p className="font-medium bg-gray-400 p-2 rounded-md text-sm">
              Software and UI/UX
            </p>
          </div>
        ...
        <a href="/projects/glovo" className="bg-white rounded-md p-4 space-y-4">
          <div className="flex items-start">
            <p className="font-medium bg-gray-400 p-2 rounded-md text-sm">
              Customer Suppport
            </p>
