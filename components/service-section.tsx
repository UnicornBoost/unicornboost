...
const ServiceSection = () => {
  return (
    <section className="md:w-4/5 md:px-0 px-4 mx-auto py-16 space-y-8">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-8">
            <div className="bg-gray-600 p-4 rounded space-y-2">
              ...
              <p className="md:text-sm text-xs">
                Easily submit and track software tasks through Stork, Trello, or
                Slack ensuring a seamless workflow from start to finish.
              </p>
            </div>
            <div className="bg-gray-600 p-4 rounded space-y-2">
              <RecycleIcon />
        ...
        <TabsContent value="aidaas" className="mt-8">
          <div className="grid md:grid-cols-3 grid-cols-1 gap-8">
            <div className="bg-gray-600 p-4 rounded space-y-2">
              <InfinityIcon />
              <h3 className="font-semibold md:text-base text-sm">
                Infinite ML solutions requests
              </h3>
              <p className="md:text-sm text-xs">
                Easily submit and track data science and ML tasks through Stork,
                Trello, or Slack ensuring a seamless workflowfrom start to
                finish.
              </p>
            </div>
            <div className="bg-gray-600 p-4 rounded space-y-2">
        ...
        <TabsContent value="csaas" className="mt-8">
          <div className="grid md:grid-cols-3 grid-cols-1 gap-8">
            <div className="bg-gray-600 p-4 rounded space-y-2">
              ...
              <p className="md:text-sm text-xs">
                Always available to make your company grow.
              </p>
            </div>
            <div className="bg-gray-600 p-4 rounded space-y-2">
              <RecycleIcon />
      ...
      <div className="flex items-center justify-center pt-4">
        <a
          href="#"
          className="bg-green-500 text-black text-sm md:text-lg px-8 py-2 text-center rounded-full font-medium"
        >
          Get Started
        </a>
      </div>
